 ...
 * @generated
 */
package com.minhtu.thrift.gen.tutorial;

import com.minhtu.thrift.gen.shared.SharedService;
...
public class Calculator {
	...
	/**
	 * Ahh, now onto the cool part, defining a service. Services just need a name and can optionally inherit from another service using the extends
	 * keyword.
	 */
	public interface Iface extends SharedService.Iface {

		/**
		 * A method definition looks like C code. It has a return type, arguments, and optionally a list of exceptions that it may throw. Note that
		...
		/**
		 * This method has a oneway modifier. That means the client only makes a request and does not listen for any response at all. Oneway methods
		 * must be void.
		 */
