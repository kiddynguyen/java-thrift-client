...
public class TProtocolUtil {
    ...
    /**
     * Specifies the maximum recursive depth that the skip function will traverse before throwing a TException. This is
     * a global setting, so any call to skip in this JVM will enforce this value.
     *
     * @param depth
     *            the maximum recursive depth. A value of 2 would allow the skip function to skip a structure or
     *            collection with basic children, but it would not permit skipping a struct that had a field containing
     *            a child struct. A value of 1 would only allow skipping of simple types and empty structs/collections.
     */
     ...
     *
     * @param prot
     *            the protocol object to read from
     * @param type
     *            the next value will be interpreted as this TType value.
     */
     ...
     *            the next value will be interpreted as this TType value.
     * @param maxDepth
     *            this function will only skip complex objects to this recursive depth, to prevent Java stack overflow.
     */
     ...
     *
     * The guess is based on known specificities of supported protocols. In some cases, no guess can be done, in that
     * case we return the fallback TProtocolFactory. To be certain to correctly detect the protocol, the first encoded
     * field should have a field id < 256
     *
     * @param data
     *            The serialized data to guess the protocol for.
     * @param fallback
