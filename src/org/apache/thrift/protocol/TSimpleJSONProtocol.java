 ...
 *
 * This protocol is write-only and produces a simple output format suitable for parsing by scripting languages. It
 * should not be confused with the full-featured TJSONProtocol.
 *
 */
