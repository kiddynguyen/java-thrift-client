...
public class TEnumHelper {
    ...
    /**
     * Given a TEnum class and integer value, this method will return the associated constant from the given TEnum
     * class. This method MUST be modified should the name of the 'findByValue' method change.
     *
     * @param enumClass
