...
public class TDeserializer {
     ...
     *            The array to read from
     * @param offset
     *            The offset into {@code bytes}
     * @param length
     *            The length to read from {@code bytes}
     */
     ...
     *            The object to read into
     * @param bytes
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path tb
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to a boolean field
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to a byte field
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to a double field
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to an i16 field
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to an i32 field
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to an i64 field
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to a string field
     * @param fieldIdPathRest
     ...
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to a binary field
     * @param fieldIdPathRest
    ...
    /**
     * Deserialize only the id of the field set in a TUnion (addressed by recursively using field id) from a byte
     * record.
     * 
     * @param bytes
     *            The serialized object to read from
     * @param fieldIdPathFirst
     *            First of the FieldId's that define a path to a TUnion
     * @param fieldIdPathRest
