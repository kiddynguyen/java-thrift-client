...
/**
 * Encapsulates an async method call Need to generate: - private void write_args(TProtocol protocol) - public T
 * getResult() throws <Exception_1>, <Exception_2>, ...
 * 
 * @param <T>
 */
public abstract class TAsyncMethodCall<T> {
    ...
    protected TAsyncMethodCall(TAsyncClient client, TProtocolFactory protocolFactory, TNonblockingTransport transport,
    ...
    /**
     * Transition to next state, doing whatever work is required. Since this method is only called by the selector
     * thread, we can make changes to our select interests without worrying about concurrency.
     * 
     * @param key
     */
