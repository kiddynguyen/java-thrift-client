...
/**
 * Servlet implementation class ThriftServer, that allows {@link TProcessor} and {@link TProtocolFactory} to be supplied
 * after the {@link #init()} method has finished. <br>
 * Subclasses must implement the abstract methods that return the TProcessor and two TProtocolFactory. Those methods are
 * guaranteed to be called exactly once, and that {@link ServletContext} is available.
 */
public abstract class TExtensibleServlet extends HttpServlet {
    ...
    /**
     * Returns the appropriate {@link TProcessor}. This will be called <b>once</b> just after the {@link #init()} method
     * 
     * @return
     */
    ...
    /**
     * Returns the appropriate in {@link TProtocolFactory}. This will be called <b>once</b> just after the
     * {@link #init()} method
     * 
     * @return
     */
    ...
    /**
     * Returns the appropriate out {@link TProtocolFactory}. This will be called <b>once</b> just after the
     * {@link #init()} method
     * 
     * @return
     */
