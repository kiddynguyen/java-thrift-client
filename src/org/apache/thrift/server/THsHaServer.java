...
/**
 * An extension of the TNonblockingServer to a Half-Sync/Half-Async server. Like TNonblockingServer, it relies on the
 * use of TFramedTransport.
 */
public class THsHaServer extends TNonblockingServer {
    ...
    protected static ExecutorService createInvokerPool(Args options) {
        ...
        ExecutorService invoker = new ThreadPoolExecutor(workerThreads, workerThreads, stopTimeoutVal, stopTimeoutUnit, queue);
     ...
     * invoking. The thread pool takes care of the rest.
     */
    @Override
