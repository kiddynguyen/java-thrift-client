...
/**
 * Generic class that encapsulates the I/O layer. This is basically a thin wrapper around the combined functionality of
...
public abstract class TTransport implements Closeable {
    ...
    public int readAll(byte[] buf, int off, int len) throws TTransportException {
        ...
        while (got < len) {
            ...
            if (ret <= 0) {
                throw new TTransportException("Cannot read. Remote side has closed. Tried to read " + len + " bytes, but only got " + got
     ...
     * @throws TTransportException
     *             if an error occurs writing data
     */
