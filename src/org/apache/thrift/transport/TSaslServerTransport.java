...
/**
 * Wraps another Thrift <code>TTransport</code>, but performs SASL server negotiation on the call to <code>open()</code>
...
public class TSaslServerTransport extends TSaslTransport {
    ...
    /**
     * Creates a <code>SaslServer</code> using the given SASL-specific parameters. See the Java documentation for
     * <code>Sasl.createSaslServer</code> for the details of the parameters.
     * 
     * @param transport
     *            The underlying Thrift transport.
     */
    public TSaslServerTransport(String mechanism, String protocol, String serverName, Map<String, String> props, CallbackHandler cbh,
    ...
    /**
     * Performs the server side of the initial portion of the Thrift SASL protocol. Receives the initial response from
     * the client, creates a SASL server using the mechanism requested by the client (if this server supports it), and
    ...
    protected void handleSaslStartMessage() throws TTransportException, SaslException {
        ...
        SaslServer saslServer = Sasl.createSaslServer(serverDefinition.mechanism, serverDefinition.protocol, serverDefinition.serverName,
                serverDefinition.props, serverDefinition.cbh);
        setSaslServer(saslServer);
    }

    /**
     * <code>TTransportFactory</code> to create <code>TSaslServerTransports<c/ode>. Ensures that a given
     * underlying <code>TTransport</code> instance receives the same <code>TSaslServerTransport</code>. This is kind of
     * an awful hack to work around the fact that Thrift is designed assuming that <code>TTransport</code> instances are
     * stateless, and thus the existing <code>TServers</code> use different <code>TTransport</code> instances for input
     * and output.
     */
    public static class Factory extends TTransportFactory {

        /**
         * This is the implementation of the awful hack described above. <code>WeakHashMap</code> is used to ensure that
        ...
        /**
         * Create a new <code>Factory</code>, initially with the single server definition given. You may still call
         * <code>addServerDefinition</code> later. See the Java documentation for <code>Sasl.createSaslServer</code> for
        ...
        /**
         * Add a supported server definition to the transports created by this factory. See the Java documentation for
         * <code>Sasl.createSaslServer</code> for the details of the parameters.
         */
        public void addServerDefinition(String mechanism, String protocol, String serverName, Map<String, String> props, CallbackHandler cbh) {
            serverDefinitionMap.put(mechanism, new TSaslServerDefinition(mechanism, protocol, serverName, props, cbh));
        ...
        /**
         * Get a new <code>TSaslServerTransport</code> instance, or reuse the existing one if a
         * <code>TSaslServerTransport</code> has already been created before using the given <code>TTransport</code> as
         * an underlying transport. This ensures that a given underlying transport instance receives the same
         * <code>TSaslServerTransport</code>.
         */
        @Override
