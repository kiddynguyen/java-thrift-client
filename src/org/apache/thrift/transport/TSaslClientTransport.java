...
/**
 * Wraps another Thrift <code>TTransport</code>, but performs SASL client negotiation on the call to <code>open()</code>
...
public class TSaslClientTransport extends TSaslTransport {
     ...
     * 
     * @param saslClient
     *            The <code>SaslClient</code> to use for the subsequent SASL negotiation.
     * @param transport
    ...
    /**
     * Creates a <code>SaslClient</code> using the given SASL-specific parameters. See the Java documentation for
     * <code>Sasl.createSaslClient</code> for the details of the parameters.
     * 
     * @param transport
     *            The underlying Thrift transport.
     * @throws SaslException
     */
    public TSaslClientTransport(String mechanism, String authorizationId, String protocol, String serverName, Map<String, String> props,
    ...
    /**
     * Performs the client side of the initial portion of the Thrift SASL protocol. Generates and sends the initial
     * response to the server, including which mechanism this client wants to use.
     */
    @Override
