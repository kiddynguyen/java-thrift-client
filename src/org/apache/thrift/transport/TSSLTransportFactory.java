...
public class TSSLTransportFactory {
    ...
    /**
     * Get a SSL wrapped TServerSocket bound to the specified port. In this configuration the default settings are used.
     ...
     * TSSLTransportParameters are used to set the values for the algorithms, keystore, truststore and other settings
     *
     * @param port
     * @param clientTimeout
     * @param ifAddress
     ...
     * @throws TTransportException
     */
    public static TServerSocket getServerSocket(int port, int clientTimeout, InetAddress ifAddress, TSSLTransportParameters params)
            throws TTransportException {
    ...
    private static TServerSocket createServer(SSLServerSocketFactory factory, int port, int timeout, boolean clientAuth, InetAddress ifAddress,
    ...
    /**
     * Get a default SSL wrapped TSocket connected to the specified host and port. All the client methods return a bound
     * connection. So there is no need to call open() on the TTransport.
     *
     * @param host
     * @param port
     * @param timeout
    ...
    private static SSLContext createSSLContext(TSSLTransportParameters params) throws TTransportException {
        ...
        try {
            ...
            if (params.isTrustStoreSet) {
                ...
                ts.load(fin, (params.trustPass != null ? params.trustPass.toCharArray() : null));
                tmf.init(ts);
            }
    ...
    public static class TSSLTransportParameters {
         ...
         *
         * @param protocol
         *            The specific protocol (TLS/SSL) can be specified with versions
         * @param cipherSuites
         */
