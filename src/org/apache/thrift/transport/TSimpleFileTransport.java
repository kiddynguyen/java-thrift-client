...
public final class TSimpleFileTransport extends TTransport {
     ...
     * @param read
     *            true to support read operations
     * @param write
     *            true to support write operations
     * @param openFile
     *            true to open the file on construction
     ...
     *            houses bytes read
     * @param off
     *            offset into buff to begin writing to
     * @param len
     ...
     * @param off
     *            offset into buffer to begin writing from
     * @param len
     ...
     *
     * @param offset
     *            bytes from beginning of file to move pointer to
     * @throws TTransportException
     *             is seek fails
     */
